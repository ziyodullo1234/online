...
import { User, Mail, Phone, BookOpen, Award, Camera, Calendar, LogOut, ChevronRight, UploadCloud, Clock } from 'lucide-react';
              ...
              <CardContent className="px-6 pb-6 pt-0 relative">
                ...
                <div className="flex flex-col items-center">
                  <div className="relative -mt-16 mb-4">
                    ...
                    {/* Avatar opsiyalari */}
                    {showAvatarOptions && (
                      <div className="absolute top-full mt-3 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-md rounded-xl shadow-2xl p-4 z-20 w-72 border border-slate-100 transition-all animate-in fade-in zoom-in duration-200">
                        <div className="flex items-center justify-between mb-3">
                          <span className="text-sm font-semibold text-slate-700">Rasm tanlang</span>
                          <button onClick={() => setShowAvatarOptions(false)} className="text-slate-400 hover:text-slate-600 text-sm">Yopish</button>
                        </div>
                        ...
                        <div className="grid grid-cols-4 gap-3 mb-4">
                          {AVATAR_OPTIONS.map((opt, idx) => (
                            <button
                              ...
                              className="w-14 h-14 rounded-full overflow-hidden hover:ring-4 hover:ring-indigo-100 transition-all focus:outline-none focus:ring-4 focus:ring-indigo-500"
                            >
                        ...
                        <Button
                          ...
                          className="w-full flex items-center justify-center gap-2 border-dashed border-2 hover:bg-slate-50"
                        >
                ...
                <div className="space-y-4 border-t border-slate-100 mt-6 pt-6">
                  <div className="flex items-center gap-4 text-slate-600 p-2 rounded-lg hover:bg-slate-50 transition-colors">
                    <div className="bg-white p-2 rounded-md shadow-sm border border-slate-100 text-indigo-500">
                        ...
                        <div className="grid grid-cols-1 gap-5">
                          {enrolledCourses.map((course) => {
                            ...
                            return (
                              <div 
                                key={course.id} 
                                className="group bg-white border border-slate-100 rounded-xl p-5 hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-100/40 transition-all duration-300 hover:-translate-y-1 cursor-default"
                                ...
                                <div className="flex flex-col sm:flex-row gap-5 items-start">
                                  ...
                                  <div className="flex-1 w-full">
                                    ...
                                    <div className="flex flex-wrap gap-3 mt-4">
                                      <Button 
                                        className={`w-full sm:w-auto opacity-50 cursor-default ${progress === 100 ? 'bg-slate-900' : 'bg-indigo-600'}`}
                                      ...
                                      {hasCertificate && (
                                        <Button variant="outline" className="w-full sm:w-auto border-emerald-200 text-emerald-700 opacity-50 cursor-default" onClick={(e) => e.preventDefault()}>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 gap-5">
                          {comingSoonCourses.map((course) => (
                            <div 
                              key={course.id} 
                              className="group bg-white border border-slate-100 rounded-xl p-5 hover:border-yellow-200 hover:shadow-xl transition-all duration-300 cursor-default"
                            >
                              <div className="flex flex-col sm:flex-row gap-5 items-start">
                                {/* Kurs Rasmi */}
                                <div className="relative shrink-0 overflow-hidden rounded-lg">
                                  ...
                                  <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                                    <div className="bg-yellow-500 text-white px-3 py-1.5 rounded-lg text-xs font-semibold flex items-center gap-1">
                                ...
                                <div className="flex-1 w-full">
                                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 mb-2">
                                    ...
                                    <Badge className="bg-yellow-50 text-yellow-700 border-yellow-200 whitespace-nowrap self-start">
                                  ...
                                  <div className="flex flex-wrap gap-3 mt-4">
                                    <Button 
                                      className="w-full sm:w-auto opacity-50 cursor-default bg-slate-400"
                                      onClick={(e) => e.preventDefault()}
                                    >
                                      Kuting
